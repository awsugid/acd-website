          ...
          {speakers.map((speaker) => (
            <div key={speaker.id} className="bg-slate-700/50 rounded-xl p-6 hover:bg-slate-700/70 transition-colors">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-slate-300 text-sm mb-4 overflow-hidden text-ellipsis" style={{display: '-webkit-box', WebkitLineClamp: 10, WebkitBoxOrient: 'vertical'}}>{speaker.bio}</p>
